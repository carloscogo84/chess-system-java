...
public class UI {
    ...
    public static void printMatch(ChessMacth chessMacth, List<ChessPiece> captured){
        printBoard(chessMacth.getPices());
        System.out.println();
        printCapturedPices(captured);
        System.out.println();
        System.out.println("Turn : " + chessMacth.getTurn());
        System.out.println("Wainting player " + chessMacth.getCurrentPlayer());
    }
